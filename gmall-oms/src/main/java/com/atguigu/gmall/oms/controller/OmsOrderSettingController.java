...
public class OmsOrderSettingController {
    ...
    public ResponseVo<PageResultVo> list(PageParamVo paramVo){
        PageResultVo pageResultVo = omsOrderSettingService.queryPage(paramVo);
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public ResponseVo<OmsOrderSettingEntity> queryOmsOrderSettingById(@PathVariable("id") Long id){
		OmsOrderSettingEntity omsOrderSetting = omsOrderSettingService.getById(id);

        return ResponseVo.ok(omsOrderSetting);
    }
    ...
    @PostMapping
    @ApiOperation("保存")
    public ResponseVo<Object> save(@RequestBody OmsOrderSettingEntity omsOrderSetting){
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public ResponseVo update(@RequestBody OmsOrderSettingEntity omsOrderSetting){
    ...
    public ResponseVo delete(@RequestBody List<Long> ids){
		omsOrderSettingService.removeByIds(ids);
