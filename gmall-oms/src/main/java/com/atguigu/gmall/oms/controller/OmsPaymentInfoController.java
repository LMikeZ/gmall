...
public class OmsPaymentInfoController {
    ...
    public ResponseVo<PageResultVo> list(PageParamVo paramVo){
        PageResultVo pageResultVo = omsPaymentInfoService.queryPage(paramVo);
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public ResponseVo<OmsPaymentInfoEntity> queryOmsPaymentInfoById(@PathVariable("id") Long id){
		OmsPaymentInfoEntity omsPaymentInfo = omsPaymentInfoService.getById(id);

        return ResponseVo.ok(omsPaymentInfo);
    }
    ...
    @PostMapping
    @ApiOperation("保存")
    public ResponseVo<Object> save(@RequestBody OmsPaymentInfoEntity omsPaymentInfo){
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public ResponseVo update(@RequestBody OmsPaymentInfoEntity omsPaymentInfo){
    ...
    public ResponseVo delete(@RequestBody List<Long> ids){
		omsPaymentInfoService.removeByIds(ids);
