...
public class OmsOrderOperateHistoryController {
    ...
    public ResponseVo<PageResultVo> list(PageParamVo paramVo){
        PageResultVo pageResultVo = omsOrderOperateHistoryService.queryPage(paramVo);
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public ResponseVo<OmsOrderOperateHistoryEntity> queryOmsOrderOperateHistoryById(@PathVariable("id") Long id){
		OmsOrderOperateHistoryEntity omsOrderOperateHistory = omsOrderOperateHistoryService.getById(id);

        return ResponseVo.ok(omsOrderOperateHistory);
    }
    ...
    @PostMapping
    @ApiOperation("保存")
    public ResponseVo<Object> save(@RequestBody OmsOrderOperateHistoryEntity omsOrderOperateHistory){
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public ResponseVo update(@RequestBody OmsOrderOperateHistoryEntity omsOrderOperateHistory){
    ...
    public ResponseVo delete(@RequestBody List<Long> ids){
		omsOrderOperateHistoryService.removeByIds(ids);
