...
public class OmsOrderItemController {
    ...
    public ResponseVo<PageResultVo> list(PageParamVo paramVo){
        PageResultVo pageResultVo = omsOrderItemService.queryPage(paramVo);
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public ResponseVo<OmsOrderItemEntity> queryOmsOrderItemById(@PathVariable("id") Long id){
		OmsOrderItemEntity omsOrderItem = omsOrderItemService.getById(id);

        return ResponseVo.ok(omsOrderItem);
    }
    ...
    @PostMapping
    @ApiOperation("保存")
    public ResponseVo<Object> save(@RequestBody OmsOrderItemEntity omsOrderItem){
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public ResponseVo update(@RequestBody OmsOrderItemEntity omsOrderItem){
    ...
    public ResponseVo delete(@RequestBody List<Long> ids){
		omsOrderItemService.removeByIds(ids);
